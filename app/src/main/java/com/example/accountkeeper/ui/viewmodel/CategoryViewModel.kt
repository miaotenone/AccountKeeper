...
class CategoryViewModel @Inject constructor(
    ...
    fun addCategory(category: Category) = viewModelScope.launch { categoryRepository.insertCategory(category) }
    ...
    private fun defaultCategories() = listOf(
        ...
        Category(name = "借出", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = true), Category(name = "应收款", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = true), Category(name = "预付款", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = true), Category(name = "押金", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = true), Category(name = "代付款", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = true), Category(name = "投资债权", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = true), Category(name = "借入", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = false), Category(name = "应付款", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = false), Category(name = "欠款", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = false), Category(name = "信用卡", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = false), Category(name = "贷款", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = false), Category(name = "分期付款", type = TransactionType.ASSET, isDefault = true, isPositiveAsset = false)
    )
}
